...
<div class="container">
  ...
  <form action="../save_server.php" method="POST" id="facultyReg">
  <legend>Register as Faculty</legend>
  <div class="form-row">
    <div class="col-md-4" >
    ...
    <input class="form-control form-control-sm" type="text" id="cname" name="cname" value="<?php echo $cname; ?>" required> 

    <label for="address">Collage Address</label> 
    ...
    <!-- <div class="d-grid gap-2 col-6 mx-auto"> -->
        <input class="btn btn-outline-primary col-12 mx-auto" type="submit" value="Register"><br>
        <!-- <a class="btn btn-outline-secondary" role="button" href='./Register.php?user=Stud'>Register as Student</a><br> -->
    <!-- </div>       -->
    <label for="">Already have account?</label>
    <a href='./Login.php?user=Faculty'>Login</a><br>

    <input type="hidden" name="page" value="facultyReg">
  </form>
</div>
...
<?php include '../nav_bar.php'; ?>
    ...
    <legend>Login as Faculty</legend>
        ...
        <div class="d-flex justify-content-around">
            ...
            <a class="col-md-5 btn btn-outline-secondary" role="button" href='./Login.php?user=Stud'>Login as Student</a>
        </div><br>
        <?php 
        if (isset($_GET['log'])) {
            if ($_GET['log'] == "404") {
